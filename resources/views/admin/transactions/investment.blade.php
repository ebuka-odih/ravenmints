                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full dataTable no-footer" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending">Earned</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending">Invest Plan</th>
                                            ...
                                            @foreach($investment as $item)
                                                <tr class="odd">
                                                    ...
                                                    <td class="fw-semibold">$ {{ $item->total_earned }}</td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.investmentDetails', $item->id) }}" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="View Deposit" data-bs-original-title="View">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <form method="POST" action="{!! route('admin.delete_investment', $item->id) !!}" accept-charset="UTF-8">
