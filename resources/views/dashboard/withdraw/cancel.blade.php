                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body modal-body-lg">
                                <div class="nk-block-head nk-block-head-xs text-center">
                                    ...
                                    <h4 class="title">Opps, Withdrawal cancelled!</h4>

                                    <div class="nk-block-text">
                                        <p class="caption-text">You have cancelled your withdrawal. Don't worry, you can make withdrawal any time in your account.</p>
                                ...
                                <div class="nk-block">
                                    <div class="nk-pps-action">
                                        <ul class="btn-group-vertical align-center gy-3">
                                            <li><a href="{{ route('user.deposit') }}" class="btn btn-lg btn-mw btn-primary">Withdraw More</a></li>
