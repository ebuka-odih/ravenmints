                ...
                <div class="nk-block">
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des">
                                <p>Basic info, like your name and address, that you use on Opennest.</p>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                                ...
                                <div class="row gy-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="firstname" class="form-control form-control-lg" id="full-name" value="{{ old('name', optional($user)->name) }}" placeholder="">
                                        </div>
                                    </div>
