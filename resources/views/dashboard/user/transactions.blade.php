            ...
            <div class="nk-content-body">
                <div class="nk-block-head">
                    <div class="nk-block-between-md g-4">
                        <div class="nk-block-head-content">
                            <h2 class="nk-block-title fw-normal">Your Transactions History</h2>
                            <div class="nk-block-des">
                                <p>List of all successful transaction from admin</p>
                            </div>
                        </div>
                ...
                <ul class="nk-nav nav nav-tabs">
                    <li class="nav-item active current-page">
                        <a class="nav-link active" href="{{ route('user.transactions') }}">History</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.deposit.transactions') }}">Deposits</a>
                    </li>
                    <li class="nav-item">
                                ...
                                <div class="tranx-col">
                                    <div class="tranx-info">
                                        ...
                                        <div class="tranx-data">
                                            <div class="tranx-label">{{ optional($item->payment_method)->name  }}
                                                {{ $item->fund_type() }} <span class="ml-3"> {!! $item->status() !!}</span></div>
